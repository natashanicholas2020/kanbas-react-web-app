...
<tr>
  <td>Math.multiply(5, 6) = {Math.multiply(5, 6)}</td>
  <td>Matematica.multiply(5, 6) =
     {Matematica.multiply(5, 6)}</td>
  <td>multiply(5, 6) = {multiply(5, 6)}</td>
</tr>
<tr>
  <td>Math.divide(14, 2) = {Math.divide(14, 2)}</td>
  <td>Matematica.divide(14, 2) =
     {Matematica.divide(14, 2)}</td>
  <td>divide(14, 2) = {divide(14, 2)}</td>
</tr>
